...
- The `hd/` PNGs generated by `scripts/generate-card-art.mjs` are 1024×1024 finished art. The Phaser renderer scales them down to the current card slot, and shipped replacements can be any square PNG at least 256×256.
