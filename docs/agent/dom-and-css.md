...
- **Status signal convention: 95%-transparent status fills, preserved borders,
  and active-player lighting.** The battlefield insets
  ...
  matching border color over that base at exactly 95% transparency, keep the
  border visible, and reserve the soft glow
