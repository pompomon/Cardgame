  ...
  it('returns no entries while the menu overlay is open, even mid target-selection', () => {
    const game = baseGame({
      players: [
        ...
        { id: 1, handCount: 0, deckCount: 10, graveyardCount: 0, handCards: [], graveyardCards: [], battlefield: [{ cardId: 'enemy-island-card-1', instanceId: 'enemy-island-1', name: 'Island' }] },
      ],
      legal: {
        playLandByCard: {
          'mountain-1': [
    ...
    const game = baseGame({
      players: [
        { id: 0, handCount: 1, deckCount: 10, graveyardCount: 0, handCards: [{ id: 'mountain-1', name: 'Mountain' }], graveyardCards: [], battlefield: [] },
        {
          ...
          graveyardCards: [],
          battlefield: [
            { cardId: 'enemy-island-card-1', instanceId: 'enemy-island-1', name: 'Island' },
            { cardId: 'enemy-island-card-2', instanceId: 'enemy-island-2', name: 'Island' },
          ],
        },
      ],
      legal: {
      ...
      players: [
        {
          ...
          graveyardCards: [],
          battlefield: [
            { cardId: 'own-forest-card-1', instanceId: 'own-forest-1', name: 'Forest' },
            { cardId: 'own-forest-card-2', instanceId: 'own-forest-2', name: 'Forest' },
          ],
        },
