...
export const STATUS_FILL_ALPHA = 0.05 // Alpha is opacity, so this is 95% transparent.
...
// Neutral player-info panel base: a 95%-transparent status tint, restrained
// border, and active-only lighting distinguish state without a saturated fill.
