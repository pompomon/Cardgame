 ...
 *   4. Status-colour fill at 95% transparency
 ...
 * and non-active insets share the same felt tone. A 95%-transparent fill
 * matching each border subtly reinforces state, and the active side also
 * receives a lighting glow.
 */
export function buildBattlefieldBackdrop(
  ...
  // Layer 4: Status fill matching the border colour at 95% transparency.
