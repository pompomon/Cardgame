      ...
      players: [
        {
          ...
          battlefield: game.players[0].battlefield.map((entry) => ({ cardId: entry.card.id, instanceId: entry.instanceId, name: entry.card.name })),
        },
        {
          id: 1,
          ...
          battlefield: game.players[1].battlefield.map((entry) => ({ cardId: entry.card.id, instanceId: entry.instanceId, name: entry.card.name })),
        },
      ],
      legal: {
        playLandByCard,
